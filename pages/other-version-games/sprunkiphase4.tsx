...
const SprunkiPhase4: NextPage = () => {
  ...
  const gameConfig = t('phase4.gameConfig', { ns: 'otherversiongamepage', returnObjects: true }) as {
    iframeSrc: string;
    loadingImage: string;
    title: string;
    description: string;
  ...
  return (
    <div className='flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen px-4 sm:px-6'>
      ...
      <IntroductionOtherVersionGame phase="phase4" />
      <OtherVersionGames />
